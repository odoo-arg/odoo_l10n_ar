...
class PerceptioPerception(models.Model):

    _name = "perception.perception"

    _description = "Perception"

    name = fields.Char(string="Nombre", required=True)

    tax_id = fields.Many2one("account.tax", string="Impuesto", required=True, domain=[('tax_group','=','perception')])
