...
class invoice(models.Model):
    ...
    def action_number(self):
        ...
        for inv in self:
            ...
            if self.type in ('in_invoice', 'in_refund'):
                local = (partner_country == company_country) or partner_country == False or partner_country == False
            else:
                local = True
    ...
    def onchange_partner_id(self, cr, uid, ids, type, partner_id,\
        ...
        if partner_id:
            ...
            res['value'].update({'pos_ar_id': False})
            res['value'].update({'denomination_id': False})
