...
class sale_shop(osv.osv):
    ...
    _columns = {
        ...
        'pos_ar_ids' : fields.one2many('pos.ar','warehouse_id','Points of Sales'),
...
class sale_order(osv.osv):
    ...
    def _make_invoice(self, cr, uid, order, lines, context=None):
        ...
        res_pos = pos_ar_obj.search(cr, uid,[('warehouse_id', '=', order.warehouse_id.id), ('denomination_id', '=', denom_id.id)])
